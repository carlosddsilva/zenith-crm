...
import {
  ZenithContactCustomFields,
  type ZenithContactCustomFieldsHandle,
} from "@/components/contacts/zenith-contact-custom-fields";
...
export function ZenithContactsPage() {
  const customFieldsRef =
    useRef<ZenithContactCustomFieldsHandle>(null);
