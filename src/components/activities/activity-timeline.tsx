...
import { CheckCircle2, Circle, Calendar, MessageSquare, Briefcase, RefreshCw, XCircle } from 'lucide-react';
  ...
  useEffect(() => {
    async function fetchActivities() {
      ...
      try {
        ...
        const res = await fetch(`/api/zenith/activities?${query.toString()}`);
