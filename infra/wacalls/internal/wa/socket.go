...
// Brazilian mobile numbers may still be represented by WhatsApp
// using the legacy PN without the inserted ninth digit.
//
// Example:
// 5566992277633 -> 556692277633
//
// The legacy candidate is only accepted if WhatsApp actually
// resolves it to a valid LID.
...
if s.cli.Store != nil &&
s.cli.Store.LIDs != nil {

lid, err :=
s.cli.Store.LIDs.GetLIDForPN(
ctx,
candidate,
)
