...
func (s *Session) resolvePeerPhone(raw string) string {
...
pn, err := s.client.Store.LIDs.GetPNForLID(
context.Background(),
jid,
)
if err != nil {
s.log.Warn(
"failed to resolve caller LID",
"lid", raw,
"error", err,
)
return raw
